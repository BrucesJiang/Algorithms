 ...
 *  Dependencies:  StdOut.java Interval2D.java StdDraw.java
 *
 *  a data type for two-dimensional intervals
 ***********************************************/
 ...
 * both {@code xmin <= x <= xmax} and {@code ymin <= y <= ymax}.
 * Two-dimensional intervals are immutable.: their values cannot be changed after they are created.
 * The class {@code Interval2D} includes methods for checking whether a two-dimensional interval contains a point
 * and determing whether two two-dimensional intervals intersect.
 * <p>
